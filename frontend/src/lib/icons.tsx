...
export function BasketIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4 fill-none stroke-current" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8.5 10 9 5.5A3 3 0 0 1 12 3a3 3 0 0 1 3 2.5l.5 4.5" />
...
export function CoinIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4 fill-none stroke-current" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 7.2v9.6M9.6 9.4c0-1.2 1.1-2.1 2.4-2.1s2.4.9 2.4 1.9c0 2.4-4.8 1.2-4.8 3.6 0 1 1.1 1.9 2.4 1.9s2.4-.9 2.4-1.9" />
    </svg>
  );
}
...
export function GiftIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4 fill-none stroke-current" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 8c-2 0-3.5-1.2-3.5-3S9.5 2 11 2c1.4 0 1 3 1 6ZM12 8c2 0 3.5-1.2 3.5-3S13.5 2 12 2c-1.4 0-1 3-1 6Z" />
    </svg>
  );
}
